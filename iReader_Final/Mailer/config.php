...
define('CONTACTFORM_FROM_ADDRESS', 'ireader2467@gmail.com');
define('CONTACTFORM_FROM_NAME', 'iReader');
...
define('CONTACTFORM_TO_ADDRESS', 'a1093324@mail.nuk.edu.com.tw');
define('CONTACTFORM_TO_NAME', 'User');

// The details of your SMTP service, e.g. Gmail.
define('CONTACTFORM_SMTP_HOSTNAME', 'smtp.gmail.com');
define('CONTACTFORM_SMTP_USERNAME', 'ireader2467@gmail.com');
define('CONTACTFORM_SMTP_PASSWORD', 'imphpa109332467');
